     ...
     var map;
      ...
      require([
        ...
        function mapLoaded(){
            ...
            var template = new PopupTemplate({title: "Código do Sensor: " + point.sensorCodigo, description: "<b> MacAddress: </b>" + point.sensorMacAddress + "<br> <b> CEP: </b>" + point.logradouroCep});        
