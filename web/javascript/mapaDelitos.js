     ...
     var map;
      ...
      require([
        ...
        function mapLoaded(){
            ...
            if((arrayPopup.indexOf(point.sensorMacAddress)) === -1)
            {
            ...
            {
                var posicao = arrayPopup.indexOf(point.sensorMacAddress);
                var descricao = arrayDescricao[posicao] + "<font color='red'><b> Ocorrência:  </b></font><b>" + point.ocorrenciaCodigo + "</b><br> <b> Placa do veículo:  </b>" + point.veiculoPlaca + "<br> <b> Marca do Veículo: </b>" + point.marcaNome + "<br> <b> Modelo do Veículo: </b> " + point.modeloNome + "<br> <b> Cor do Veículo: </b>" + point.veiculoCor + "<br> <b> Ano do Veículo: </b>" + point.veiculoAno + "<br> <b> Momento do Registro: </b> " + point.registroMomento + "<br> <b> Logradouro: </b>" + point.logradouroNome + "<br> <b> Bairro: </b>" + point.bairroNome + "<br> <b> Cidade: </b>" + point.cidadeNome + "<br> <b> Estado: </b>" + point.estadoNome + "<br><br>";
                arrayDescricao[posicao] = descricao;              
            }
          });
                    
          for (i = 0; i < arrayGraphic.length; i++) {
                var template = new PopupTemplate();
                template.setContent(arrayDescricao[i]);
                arrayGraphic[i].setInfoTemplate(template);
                map.graphics.add(arrayGraphic[i]);
          }
                ...
                if(tipo === "listarDelito")
                {
                    ...
                    for (var i = 0; i < arrayListDelitos.length; i++)
                    {
                        var metadados = {
                            ...
                            coordenadas: [arrayListDelitos[i].sensorLongitude, arrayListDelitos[i].sensorLatitude]};
